...
export const ctaMessages = {
  hero: "Oi! Vim pelo site da Fachada. Queria saber mais.",
  cardapio_card:
  ...
  galeria_quero:
    "Oi! Vi a galeria do site da Fachada. Queria algo parecido com [_____].",
  cta_final_cardapio: "Oi! Quero o cardápio QR de R$ 247.",
  cta_final_site: "Oi! Quero o site profissional de R$ 397.",
  whatsapp_sticky: "Oi! Vim pelo site da Fachada. Pode me ajudar?",
  topo_pequeno: "Oi! Vim pelo site da Fachada."
} as const;
